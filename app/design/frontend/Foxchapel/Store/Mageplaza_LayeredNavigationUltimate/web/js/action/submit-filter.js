...
define(
    [
        ...
        'Amasty_Quickview/js/amquickview'
    ],
            ...
            return storage.post(submitUrl).done(
                function (response) {
                    ...
                    if (productsHtml) {
                        ...
                        // To fix Quick View issue.
                        $("li.product-item").amQuickview({"url":"\/catalog\/product\/view\/amasty_quickview\/1\/","text":"QUICK VIEW","css":null,"selectors":{"productContainer":".product-image-container","productImage":".product-image-photo","productImageContainer":".item, .product-item"}});
                    }
                }
            ).fail(
                function () {

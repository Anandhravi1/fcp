...
use FoxChapel\NewsFeed\Api\Data\DataSearchResultsInterfaceFactory;
use FoxChapel\NewsFeed\Model\ResourceModel\Data as ResourceData;
use FoxChapel\NewsFeed\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \FoxChapel\NewsFeed\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \FoxChapel\NewsFeed\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \FoxChapel\NewsFeed\Model\ResourceModel\Data\Collection $collection */

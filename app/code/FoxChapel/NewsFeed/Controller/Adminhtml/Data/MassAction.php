...
use FoxChapel\NewsFeed\Model\Data as DataModel;
use FoxChapel\NewsFeed\Model\ResourceModel\Data\CollectionFactory;
...
abstract class MassAction extends Data
{
    ...
    public function execute()
    {
        ...
        $redirectResult->setPath('newsfeed/data/index');

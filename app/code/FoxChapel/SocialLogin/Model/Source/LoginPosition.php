...
namespace FoxChapel\SocialLogin\Model\Source;
...
class LoginPosition implements \Magento\Framework\Option\ArrayInterface
{
    ...
    const BELOW_LOGIN_HEADING = 'below_login_heading';
    ...
    public function toArray()
    {
        return [
            ...
            self::BELOW_LOGIN_HEADING => __('Below customer login form heading')
        ];
    }
}
